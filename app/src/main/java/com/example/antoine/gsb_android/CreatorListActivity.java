...
/**
 * Created by Antoine on 23/05/2017.
 */
...
public final class CreatorListActivity extends ListActivity {

    private static final String GITHUB_JSON_URL = "https://api.github.com/orgs/GSBAndroidCreator/members";
    private RequestQueue mRequestQueue;
    private com.example.antoine.gsb_android.CreatorListAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new com.example.antoine.gsb_android.CreatorListAdapter(app, imageLoader);
    ...
    protected void onResume() {
        ...
        JsonArrayRequest request = new JsonArrayRequest(GITHUB_JSON_URL,
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                Toast.makeText(CreatorListActivity.this, "Error while getting JSON: " + volleyError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        request.setTag(this);
